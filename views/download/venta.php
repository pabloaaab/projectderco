...
$this->title = 'Exportar Registros Ventas';
?>

<h1>Exportar Registros Ventas</h1>
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("download/venta"),
...
<div class="panel panel-primary panel-filters">
    ...
    <div class="panel-body" id="filtrodownloadventa">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("download/venta") ?>" class="btn btn-primary">Limpiar</a>
        </div>
    </div>
</div>
